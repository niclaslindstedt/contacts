...
Instead, please report privately via [GitHub Security Advisories](https://github.com/niclaslindstedt/contacts/security/advisories/new),
...
In scope: any vulnerability in the published release of contacts — in
particular the at-rest encryption path (`withEncryption` usage, passphrase
handling) and the OAuth token handling for the cloud backends.
