...
Finding a contact no longer starts with reaching for a button. With a keyboard
attached, **just start typing** — anywhere in the app, as long as you're not
already writing in a field — and the search overlay opens with your keystroke
already in the box. Type "mir" and Mirjam is right there. Prefer a shortcut?
**Ctrl+K** (or **Cmd+K** on a Mac) opens the same search from anywhere, even
