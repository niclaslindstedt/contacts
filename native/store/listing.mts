...
export const RULES: StoreRules = {
  ...
  brand: {
    ...
    marketingUrl: "https://contacts.niclaslindstedt.se/",
    ...
    // behaviour does.
    privacyUrl: "https://apps.agilator.se/contacts/privacy/",
    supportUrl: "https://apps.agilator.se/contacts/support/",
  },

  // Contacts ships on the App Store alone. There is no Mac App Store record and
  ...
  apple: {
    // An address book. PRODUCTIVITY is the aisle; UTILITIES second because
    // it is a small local tool that does one thing.
    ...
    advisory: {
      ...
      // A contact card is whatever the reader typed. The app records
      // nothing medical of its own and gives no advice.
