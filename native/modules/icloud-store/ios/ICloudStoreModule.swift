...
// address book is visible in the Files app under "Contacts" rather than
...
public class ICloudStoreModule: Module {
  ...
  /// but the container holds the reader's whole address book, and a store that
  ...
  /// does not own. `photos/.a.jpg.icloud` is `photos/a.jpg`; any other
