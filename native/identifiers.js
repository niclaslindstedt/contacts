...
const PROJECT_NAME = "Contacts";

/** Reverse-DNS id used only by local/dev builds; never submitted. */
const DEV_BUNDLE_ID = "dev.local.contacts";
...
// `iCloud.dev.local.contacts` while the module's Swift — which cannot read a
...
const ICLOUD_CONTAINER = "iCloud.se.agilator.contacts";
