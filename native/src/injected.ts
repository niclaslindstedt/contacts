...
// guessing.
//
// Nothing about a contact is read here, and nothing is stored. The only other
...
export const REPORT_TYPE = "contacts-native/report";
...
export const AFTER_LOAD_SCRIPT = `(function () {
  ...
  window.__contactsNativeReporter = true;
