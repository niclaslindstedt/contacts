...
// `http://localhost:8241…`: an origin it does not have registered, in a
...
export const AUTH_SESSION_REQUEST_TYPE = "contacts-native/auth-session-request";
 ...
 * is `app.config.js`'s `scheme` (the bundle id, `se.agilator.contacts` in the
