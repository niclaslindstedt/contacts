...
// and every bar that meets an edge (the list header, the side menu, the toasts) pads itself with
...
export default function App() {
  ...
  // Keep the WebView on the embedded app. Anything else — a link on a contact
  // card, the privacy policy's own links — belongs in the system browser,
      ...
      >
        ...
        {origin ? (
          <WebView
            ...
            // once the page has loaded, and all are guarded against a second
