...
| Helper                         | What it does                                                                                                                                                                                                                                                |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `openApp(page)`                | Navigate to the app root and wait until the shell has rendered (the card's Edit/Done control, the docked sidebar's "New contact", or the phone's "Open sidebar" button — the seeded app can boot to the List page with no card open). Universal first step. |
