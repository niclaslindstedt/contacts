...
// `FloatingPanel` primitives plus the theme module's `AppearancePicker`. A
// header whose menu button opens the tab list, a scrolling tab body, and a
// Reset / Cancel / Save footer. Edits to the appearance preview live; the
