...
export const sv: Catalog = {
  ...
  contact: {
    ...
    relation: "Relation",
    relationPlaceholder: "Välj en relation",
    relationNone: "Ingen",
    relations: {
      family: "Familj",
      partner: "Partner",
      friend: "Vän",
      colleague: "Kollega",
      business: "Affärskontakt",
    },
    relationCustomAdd: "Lägg till egen…",
    relationCustomLabel: "Ny relation",
    relationCustomPlaceholder: "t.ex. Granne",
    tags: "Taggar",
